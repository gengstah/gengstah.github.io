---
title: VTL Secure Calls — NT ↔ Secure Kernel Interface
permalink: /wiki/kernel/vtl_secure_calls/
layout: single
author_profile: true
tags:
...
> **Related:** [Mitigations](/wiki/kernel/mitigations/), [Architecture](/wiki/kernel/architecture/)  
...
**Key tool**: Connor McGarr's [SkBridge](https://github.com/connormcgarr/SkBridge) — allows issuing arbitrary secure calls from kernel mode; [Vtl1Mon](https://github.com/connormcgarr/Vtl1Mon) — ETW-based VTL 1 entry/exit monitoring.
...
- Connor McGarr — [SkBridge](https://github.com/connormcgarr/SkBridge) tool
- Connor McGarr — [Vtl1Mon](https://github.com/connormcgarr/Vtl1Mon) tool
