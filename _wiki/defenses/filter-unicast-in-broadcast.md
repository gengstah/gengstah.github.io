...
permalink: /wiki/defenses/filter-unicast-in-broadcast/
layout: single
author_profile: true
tags:
- airsnitch
...
- The full class of [Broadcast Reflection](/wiki/attacks/broadcast-reflection/) when the attacker uses IPv6 or ARP payloads.
- [Gateway Bouncing](/wiki/attacks/gateway-bouncing/), [Port Stealing](/wiki/attacks/port-stealing/), [Machine-on-the-side](/wiki/attacks/machine-on-the-side/), [Rogue AP](/wiki/attacks/rogue-ap/) — none touch this code path.
...
- [Group key randomization](/wiki/defenses/group-key-randomization/) — the AP-side counterpart that closes the same attack at the source.
