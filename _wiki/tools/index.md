...
- [Cobalt Strike](/wiki/tools/cobalt-strike-offsec/)
- [Cobalt Strike](/wiki/tools/cobalt-strike/) — The dominant commercial adversary-emulation / C2 platform.
...
- [Setup Scripts and the Simulated Testbed](/wiki/tools/setup-scripts/)
- [WMIC](/wiki/tools/wmic/)
