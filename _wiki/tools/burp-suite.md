---
title: Burp Suite
permalink: /wiki/tools/burp-suite/
layout: single
author_profile: true
tags:
- offsec-notes
- tool
redirect_from:
- /wiki/offsec-notes/entities/burp-suite/
---

**Type:** Tool
**Also known as:** Burp, Burp Suite Professional, Burp Suite Community
**Related:** [Web Application Testing](/wiki/concepts/web-application-testing/), [Sql Injection](/wiki/concepts/sql-injection/), [Xss](/wiki/concepts/xss/)
