...
- tool
redirect_from:
- /wiki/offsec-notes/entities/wmic/
---
...
**Related:** [Evasion Techniques](/wiki/concepts/evasion-techniques/), [Lateral Movement](/wiki/concepts/lateral-movement/), [Post Exploitation](/wiki/concepts/post-exploitation/)
