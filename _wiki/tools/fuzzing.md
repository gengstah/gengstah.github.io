---
title: Fuzzing Tools for Windows Kernel & User-Mode
permalink: /wiki/tools/fuzzing/
layout: single
author_profile: true
tags:
...
> **Related:** [Debugging](/wiki/tools/debugging/), [Dynamic Analysis](/wiki/tools/dynamic_analysis/)  
...
- Minimized corpus: run `afl-cmin` or WTF corpus minimization
- Include edge cases: zero sizes, maximum sizes, empty inputs
