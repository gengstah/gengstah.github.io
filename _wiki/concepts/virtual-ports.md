...
permalink: /wiki/concepts/virtual-ports/
layout: single
author_profile: true
tags:
- airsnitch
...
- **VLAN per BSSID, with the bridge crossed by routing only.** Port-stealing the MAC of an interface in a different VLAN gets you the wrong forwarding domain. See [VLANs and firewall](/wiki/defenses/vlans/).
...
- [BSSID, SSID, ESS](/wiki/concepts/bssid-ssid-ess/)
- [Port stealing](/wiki/attacks/port-stealing/)
- [Broadcast Reflection](/wiki/attacks/broadcast-reflection/) — a cousin attack that also exploits the bridge.
