...
permalink: /wiki/concepts/privilege-escalation-linux/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Privilege Escalation Windows](/wiki/concepts/privilege-escalation-windows/), [Post Exploitation](/wiki/concepts/post-exploitation/), [Lateral Movement](/wiki/concepts/lateral-movement/)
