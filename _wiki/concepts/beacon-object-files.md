...
permalink: /wiki/concepts/beacon-object-files/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Command And Control](/wiki/concepts/command-and-control/), [Cobalt Strike](/wiki/tools/cobalt-strike-offsec/), [Evasion Techniques](/wiki/concepts/evasion-techniques/)
