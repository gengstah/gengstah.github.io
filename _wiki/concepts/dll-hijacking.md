...
permalink: /wiki/concepts/dll-hijacking/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Privilege Escalation Windows](/wiki/concepts/privilege-escalation-windows/), [Evasion Techniques](/wiki/concepts/evasion-techniques/), [Post Exploitation](/wiki/concepts/post-exploitation/)
...
See [Notepadplusplus Abuse](/wiki/concepts/notepadplusplus-abuse/) for plugin-as-DLL persistence.
