...
permalink: /wiki/concepts/active-directory-attacks/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Kerberoasting](/wiki/concepts/kerberoasting/), [Pass The Hash](/wiki/concepts/pass-the-hash/), [Lateral Movement](/wiki/concepts/lateral-movement/), [Privilege Escalation Windows](/wiki/concepts/privilege-escalation-windows/), [Bloodhound](/wiki/tools/bloodhound/), [Mimikatz](/wiki/tools/mimikatz/)
...
#### Credential Attacks
- Kerberoasting — request TGS for SPN accounts, crack offline (see [Kerberoasting](/wiki/concepts/kerberoasting/))
- AS-REP Roasting — accounts with "Do not require Kerberos pre-auth"
- Password spraying — low-and-slow against domain accounts
- Pass-the-Hash / Pass-the-Ticket (see [Pass The Hash](/wiki/concepts/pass-the-hash/))
