---
title: Passpoint
permalink: /wiki/concepts/passpoint/
layout: single
author_profile: true
tags:
- airsnitch
...
updated: 2026-04-28
redirect_from:
- /wiki/airsnitch/concepts/passpoint/
---
...
The intent: every client gets a *different* [GTK](/wiki/concepts/wifi-key-hierarchy/), so an insider's GTK can't be used to inject broadcast frames at any other client. To still handle protocols that genuinely need broadcast (ARP, DHCP), the AP performs **Proxy ARP** and other broadcast-to-unicast translations.
...
- the [group-key handshake](/wiki/concepts/handshakes/#group-key-handshake) (used for periodic GTK rotation)
- the [FT handshake](/wiki/concepts/handshakes/#fast-bss-transition-ft-handshake-ieee-80211r)
- the [FILS handshake](/wiki/concepts/handshakes/#fast-initial-link-setup-fils-handshake-ieee-80211ai)
...
**No isolation outside Wi-Fi.** Passpoint addresses only the Wi-Fi encryption layer. It says nothing about [routing](/wiki/attacks/gateway-bouncing/) or [internal switching](/wiki/attacks/port-stealing/). So an attacker just routes around it.
...
- Defences that originated in Passpoint (DGAF Disable, Proxy ARP) are good ideas to enable on any network where you care about [client isolation](/wiki/concepts/client-isolation/). They just need to extend to all GTK-bearing handshakes and to IGTK.

## See also

- [Wi-Fi key hierarchy](/wiki/concepts/wifi-key-hierarchy/)
- [Handshakes](/wiki/concepts/handshakes/)
- [Passpoint flaws attack](/wiki/attacks/passpoint-flaws/)
- [Group key randomization defence](/wiki/defenses/group-key-randomization/)
