...
permalink: /wiki/concepts/windows-service-triggers/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Privilege Escalation Windows](/wiki/concepts/privilege-escalation-windows/), [Lateral Movement](/wiki/concepts/lateral-movement/), [Wmic](/wiki/tools/wmic/)
