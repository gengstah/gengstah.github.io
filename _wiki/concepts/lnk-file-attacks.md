...
permalink: /wiki/concepts/lnk-file-attacks/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Phishing](/wiki/concepts/phishing/), [Post Exploitation](/wiki/concepts/post-exploitation/), [Active Directory Attacks](/wiki/concepts/active-directory-attacks/)
