...
permalink: /wiki/concepts/mdt-credential-extraction/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Active Directory Attacks](/wiki/concepts/active-directory-attacks/), [Post Exploitation](/wiki/concepts/post-exploitation/), [Lateral Movement](/wiki/concepts/lateral-movement/)
