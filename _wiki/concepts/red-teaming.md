---
title: Red Teaming
permalink: /wiki/concepts/red-teaming/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Related:** [Purple Teaming](/wiki/concepts/purple-teaming/), [Command And Control](/wiki/concepts/command-and-control/), [Social Engineering](/wiki/concepts/social-engineering/), [Phishing](/wiki/concepts/phishing/), [Post Exploitation](/wiki/concepts/post-exploitation/)
...
#### 2. Reconnaissance
Full OSINT campaign (see [Reconnaissance](/wiki/concepts/reconnaissance/)). Map employees, tech stack, physical locations.
...
Deploy beacon with resilient C2 infrastructure (see [Command And Control](/wiki/concepts/command-and-control/)). Establish persistence early in case of detection/remediation.
...
## Tools
- C2: Cobalt Strike, Sliver, Havoc (see [Command And Control](/wiki/concepts/command-and-control/))
