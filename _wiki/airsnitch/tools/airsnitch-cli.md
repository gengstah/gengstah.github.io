...
permalink: /wiki/airsnitch/tools/airsnitch-cli/
layout: single
author_profile: true
tags:
- airsnitch
...
| Option | Purpose |
| --- | --- |
| `--config <file>` | Path to the supplicant config (default `client.conf`). See [configuration files](/wiki/airsnitch/tools/configurations/). |
...
| Flag | Attack | Page |
| --- | --- | --- |
| `--check-gtk-shared <iface2>` | Verify whether victim and attacker receive the same GTK | [Abusing GTK](/wiki/airsnitch/attacks/abusing-gtk/) |
| `--c2c-gtk-inject <iface2>` | Inject a unicast IP packet wrapped in a GTK-encrypted broadcast frame | [Abusing GTK](/wiki/airsnitch/attacks/abusing-gtk/) |
| `--c2c-broadcast <iface2>` | Test [Broadcast Reflection](/wiki/airsnitch/attacks/broadcast-reflection/) (`ToDS=1, addr3=ff:ff:..`) | [Broadcast Reflection](/wiki/airsnitch/attacks/broadcast-reflection/) |
| `--c2c-ip <iface2>` | Test [Gateway Bouncing](/wiki/airsnitch/attacks/gateway-bouncing/) (L3 client-to-client) | [Gateway Bouncing](/wiki/airsnitch/attacks/gateway-bouncing/) |
| `--c2c-eth <iface2>` | Direct L2 client-to-client traffic (baseline / sanity check) | [Client isolation concept](/wiki/airsnitch/concepts/client-isolation/) |
| `--c2c <iface2>` | ARP-based client-to-client (legacy ARP poisoning baseline) | [Client isolation concept](/wiki/airsnitch/concepts/client-isolation/) |
| `--c2c-port-steal <iface2>` | Test [downlink port stealing](/wiki/airsnitch/attacks/port-stealing/#downlink) | [Port Stealing](/wiki/airsnitch/attacks/port-stealing/) |
| `--c2c-port-steal-uplink <iface2>` | Test [uplink port stealing](/wiki/airsnitch/attacks/port-stealing/#uplink) | [Port Stealing](/wiki/airsnitch/attacks/port-stealing/) |
...
| Flag | Purpose |
| --- | --- |
| `--reinject-reflection` | After interception, return packets to the victim using [Broadcast Reflection](/wiki/airsnitch/attacks/broadcast-reflection/) |
| `--reinject-gtk <iface3>` | After interception, return packets using [GTK abuse](/wiki/airsnitch/attacks/abusing-gtk/) over a third NIC |
...
- Whether the IGTK group key is randomized under client isolation. (See [Passpoint flaws](/wiki/airsnitch/attacks/passpoint-flaws/).)
...
- [Library internals](/wiki/airsnitch/tools/repo-layout/#library)
