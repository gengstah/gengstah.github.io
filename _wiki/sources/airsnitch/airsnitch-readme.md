...
permalink: /wiki/sources/airsnitch/airsnitch-readme/
layout: single
author_profile: true
tags:
- airsnitch
...
6. **Defenses and mitigations.** The eight-step defensive recommendation set the wiki's [defenses index](/wiki/defenses/) is built from.
...
- *Switching to WPA3 alone does not stop the attacks.* The README is explicit. See [WPA versions](/wiki/concepts/wpa-versions/).
- *Most attacks are independent of the encryption protocol.* See the matrix in [overview](/wiki/concepts/airsnitch-overview/).
