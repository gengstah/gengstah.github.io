...
permalink: /wiki/offsec-notes/concepts/wi-fi-client-isolation-bypass/
layout: single
author_profile: true
tags:
- offsec-notes
...
## Tools
- [Airsnitch](/wiki/offsec-notes/entities/airsnitch/) (macstealer) — PoC framework implementing gateway bouncing, port stealing, GTK abuse
