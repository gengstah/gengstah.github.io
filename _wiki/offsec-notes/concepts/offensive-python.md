...
permalink: /wiki/offsec-notes/concepts/offensive-python/
layout: single
author_profile: true
tags:
- offsec-notes
...
- Consider running payloads inside Notepad++ PythonScript (signed loader process) — see [Notepadplusplus Abuse](/wiki/offsec-notes/concepts/notepadplusplus-abuse/)
