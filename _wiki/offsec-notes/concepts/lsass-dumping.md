---
title: LSASS Dumping
permalink: /wiki/offsec-notes/concepts/lsass-dumping/
layout: single
author_profile: true
tags:
- offsec-notes
...
**Note:** On Windows 11 with Credential Guard enabled, LSASS no longer holds high-value credentials — see [Credential Guard Bypass](/wiki/offsec-notes/concepts/credential-guard-bypass/) for bypass techniques.
